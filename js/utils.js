...
const Utils = (() => {
  ...
  // 읽기 설정(스킨/폰트) — 미리보기와 모든 내보내기(Tistory HTML, PDF)가 공유하는
  // 단일 기준. 여기서만 정의하고 app.js / exporter.js 양쪽에서 참조한다.
  const SKIN_MAP = {
    light: { bg: '#ffffff', text: '#2B2620', card: '#F1EBDD', border: '#E2D9C4' },
    sepia: { bg: '#f5ecd9', text: '#3a2f1f', card: '#ecdfc2', border: '#ddccA0' },
    mint:  { bg: '#eaf4ef', text: '#1e332c', card: '#d8ebe2', border: '#bfdccf' },
    dark:  { bg: '#1b1926', text: '#ECE7E0', card: '#242131', border: '#332f42' }
  };
  const FONT_MAP = {
